...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// LoginButton
			// 
			this->LoginButton->Location = System::Drawing::Point(431, 231);
			this->LoginButton->Name = L"LoginButton";
			this->LoginButton->Size = System::Drawing::Size(75, 25);
			...
			this->label1->Location = System::Drawing::Point(348, 182);
			...
			this->label2->Location = System::Drawing::Point(350, 208);
			...
			// UserEdit
			// 
			this->UserEdit->Location = System::Drawing::Point(415, 179);
			this->UserEdit->Name = L"UserEdit";
			this->UserEdit->Size = System::Drawing::Size(130, 20);
			this->UserEdit->TabIndex = 3;
			// 
			// PasswordEdit
			// 
			this->PasswordEdit->Location = System::Drawing::Point(415, 205);
			this->PasswordEdit->Name = L"PasswordEdit";
			this->PasswordEdit->Size = System::Drawing::Size(130, 20);
			...
			this->Text = L"CWTS Inventory Management System";
...
private: System::Void LoginButton_Click(System::Object^ sender, System::EventArgs^ e) {
	fstream Loginfile;
	Loginfile.open("Login.txt",ios::in);
